...
function Get-RegexExtractorPage {
    param([hashtable]$Context)

    $toolManifest = Get-PacToolManifest -RootPath $Context.RootPath -ManifestPath 'Tools/Regex Extractor/tool.json'
...
function Show-RegexExtractorWindow {
    $toolManifest = Get-PacToolManifest -RootPath $script:PacRootPath -ManifestPath 'Tools/Regex Extractor/tool.json'
