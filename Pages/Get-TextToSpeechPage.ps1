...
function Get-TextToSpeechPage {
    param(
        [hashtable]$Context
    )

    $toolManifest = Get-PacToolManifest -RootPath $Context.RootPath -ManifestPath 'Tools/Text to Speech/tool.json'
...
function Show-TextToSpeechWindow {
    $toolManifest = Get-PacToolManifest -RootPath $script:PacRootPath -ManifestPath 'Tools/Text to Speech/tool.json'
